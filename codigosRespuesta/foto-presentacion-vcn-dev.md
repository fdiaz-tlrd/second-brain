...
| Filas foto (código+descripción) | 25 |
| Contratos (columnas) | A.mensajeError, A.descripcionError, B |
| Patrones estructurales únicos | 26 |
...
| 418 | Método no soportado | x | - | - | 4 | 200 | sí |
| 418 | Metodo no soportado por el validador | x | - | - | 4 | 200 | no |
| 425 | Cantidad de solicitudes no permitidas. | x | - | - | 16 | 200 | sí |
| 431 | Campo idSolicitud no cumple con los criterios | x | - | - | 88 | 200 | sí |
| 500 | ERROR: Excepción no controlada al momento de buscar la información del canal | x | - | - | 20 | 200 | no |
...
| 5 | A.mensajeError | 400 | mensajeError | `codigoError,mensajeError` | 200 | sí | 32 | 0001.3.1008.1.2. validador por SWIFT CELEGATO — cuenta feliz (exito) |
...
| 12 | A.mensajeError | 418 | mensajeError | `codigoError,mensajeError` | 200 | no | 4 | 2.4.1. metodo — no está en CFG_METODOS_LIMITES_JSON (418) |
| 13 | A.mensajeError | 418 | mensajeError | `codigoError,mensajeError` | 200 | sí | 4 | 2.4.2. metodo — no asociado al canal emisor (418) [CANAL_EMISOR_SIN_METODO] |
| 14 | A.mensajeError | 425 | mensajeError | `codigoError,mensajeError` | 200 | sí | 16 | 1.5.1. solicitudes — tipo string (425) |
| 15 | A.mensajeError | 431 | mensajeError | `codigoError,mensajeError` | 200 | sí | 88 | 1.5.4. solicitudes — sin propiedad idSolicitud (431) |
| 16 | A.mensajeError | 500 | mensajeError | `codigoError,mensajeError` | 200 | no | 20 | 1.2.4. validador — tipo number (400) |
| 17 | A.mensajeError | 509 | mensajeError | `codigoError,mensajeError` | 200 | no | 32 | 1.4.9. idPeticion — longitud 7, mínimo 8 (400) |
| 18 | A.mensajeError | 599 | mensajeError | `codigoError,mensajeError` | 200 | no | 8 | 0001.5.1022.1. validador PROXGATO auth fijo — demora validador (599) |
| 19 | B | 0 | — | `idPeticion,respuestas` | 200 | sí | 604 | 1.2.15. validador — distinto a {{CANAL_VALIDADOR}} (CANAL_EMISOR) (400) |
| 20 | B | 413 | — | `idPeticion,respuestas` | 200 | sí | 80 | 0001.1.1.1. cuenta — propiedad ausente (413) |
| 21 | B | 510 | — | `idPeticion,respuestas` | 200 | sí | 32 | 0001.2.1008.510. validador CELEGATO — Número de cuenta incorrecta (510) |
| 22 | B | 511 | — | `idPeticion,respuestas` | 200 | sí | 32 | 0001.2.1008.511. validador CELEGATO — Número de cuenta cerrado (511) |
| 23 | B | 512 | — | `idPeticion,respuestas` | 200 | sí | 32 | 0001.2.1008.512. validador CELEGATO — Número de cuenta bloqueado (512) |
| 24 | B | 513 | — | `idPeticion,respuestas` | 200 | sí | 32 | 0001.2.1008.513. validador CELEGATO — Transacción no permitida (513) |
| 25 | B | 514 | — | `idPeticion,respuestas` | 200 | sí | 32 | 0001.2.1008.514. validador CELEGATO — Falta información obligatoria de consulta (514) |
| 26 | B | 515 | — | `idPeticion,respuestas` | 200 | sí | 32 | 0001.2.1008.515. validador CELEGATO — Razón regulatoria (515) |
