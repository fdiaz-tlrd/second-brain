...
|--------|-------------|---|---|---|------------|-------------|---------|
| 0 | *(sin texto; solo resultado)* | - | - | x | 644 | 200 | sí |
...
| 418 | Método no soportado por el validador | x | - | - | 16 | 200 | no |
...
| 482 | Método no disponible para el Canal Emisor | x | - | - | 12 | 200 | sí |
...
| 12 | A.mensajeError | 418 | mensajeError | `codigoError,mensajeError` | 200 | no | 16 | 2.5.1 matriz (∅,∅) emisor sin ops + validador sin ops (418) |
...
| 16 | A.mensajeError | 482 | mensajeError | `codigoError,mensajeError` | 200 | sí | 12 | 2.4.2. metodo — negado explícitamente para el canal emisor (482) [CANAL_EMISOR_SIN_METODO] |
...
| 20 | B | 0 | — | `idPeticion,respuestas` | 200 | sí | 644 | 1.2.15. validador — distinto a {{CANAL_VALIDADOR}} (CANAL_EMISOR) (400) |
