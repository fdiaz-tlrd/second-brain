...
| 418 | Método no soportado |  | - Método no soportado | - Si envía un método distinto al esperado. (0001) | Método no soportado | Cuando se hace petición a un método inexistente. | Método no soportado | Cuando se hace petición a un método inexistente. |
