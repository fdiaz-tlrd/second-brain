# Reglas del workspace (fijas)

Documentación **estable** sobre qué el agente puede o no puede tocar en `c:\Users\Lenovo\GitHub\`.

**No** confundir con la carpeta volátil del usuario (servilleta entre máquinas); no guardar reglas ahí.
...
| [`investigacion-solo-usuario.md`](./investigacion-solo-usuario.md) | `second-brain/investigacion/` — solo del usuario; estudio va en otra carpeta |
