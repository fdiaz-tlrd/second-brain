...
| **R2P Newman (paridad Dig)** | [`../tld-api-r2p/17-estrategia-newman-r2p-paridad-dig.md`](../tld-api-r2p/17-estrategia-newman-r2p-paridad-dig.md) | Suite mínima `r2p` lista; paridad deploys/VPN pendiente; no ambición tipo VCN |
