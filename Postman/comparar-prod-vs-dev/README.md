...
**Revisión P2P:** [`13-revision-codigos-respuesta-p2p.md`](13-revision-codigos-respuesta-p2p.md) — run `09-47-19Z` **cerrado** (540 únicos = 382 OK + 158 con problema): **82 PROD-MAL** (46 transversal VCN + 30 alias HP-023…026 + 2 plan HP-015 + 4 crash HP-028), **1 HP-027** (doc `idPeticion` + granularidad 445), **75 N/A mejora dev** (62 preguntas seguridad + 13 bancoAcreedor 414→435). Suma 46+30+2+4+1+62+13 = 158. **Bloque E**: 17 escenarios `null` auditados (punto ciego del barrido corregido). Run `08-53` invalidado (509 config).
